...
\textit{(Required only for advanced, although beginners are welcome as well!)} - Advanced students are expected to register and compete in a competition during the semester. Our club hosts in-person competitions which will be announced later during the semester. %Competitions can be found at the following links:
...
2  & Step 2: First layer & Intro to first two layer solving & Group Introduction \\ \hline
...
4  & Steps 4-5: Orientation of the last layer & Two look PLL & Subgroups and Lagrange's Theorem \\ \hline
...
6  & Buffer/review week. Perfect solving the cube from start to finish & Advanced cross solving and fingertricks & Permutation cycle notation \\ \hline
...
9 & Advanced cross solving & Easy algorithms to learn  & Transpositions and Parity \\ \hline

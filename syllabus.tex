...
$\textbf{Semester}$: Spring 2020\\
$\textbf{Room}$: TBD\\
$\textbf{Time}$: TBD 5-7 PM (Beginners 5-6 PM, Advanced 6-7 PM)\\
$\textbf{Starting Date}$: February 12th\\
$\textbf{Facilitators}$: Abhimanyu Singhal, Tiffany Chien, Uma Unni, and others\\
...
\section*{Enrollment}
Deadline to fill out the application listed on the DeCal website — February 8th
We will select ~120 applicants and send them an email with the CCNs on February 10th
The CCNs will be made available to everyone on the DeCal website on February 12th
First class is on February 12th
The CCNs will be taken off from the DeCal website on February 14th
...
7  & Intro to some simple shortcuts & Inspection, cutting rotations and efficiency & Checkpoint quiz 2: Solve the cube (under 1:30 for advanced) \\ \hline
8  & Advanced cross solving & Easy algorithms to learn  & \\ \hline
9 & Intro to four look last layer algorithms & Orientation for future learning: how to improve after the class is over & Do the assigned reading (TBA) \\ \hline
10 & Finals part 1 &  & \\ \hline
11 & Finals part 2 &  & \\ \hline
\end{longtable}
\end{center}
...
The reading quiz will cover the readings assigned Week 10. The topics covered in the readings include but are not limited to: the history of the Rubik’s cube, the mathematics behind the Rubik’s cube (in particular, group theory), current state of the Rubik’s cube community, and algorithm intuition and development. The quiz will be due one week after the readings are assigned. The readings will be posted shortly after the beginning of the course to give students plenty of time to read them ahead of time.
